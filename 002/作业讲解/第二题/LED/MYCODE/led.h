...
#define		GPIOE_MODER   	*((volatile unsigned int *)(0x40021000+0X00))	//值转为地址，通过解引用访问地址空间的值
#define		GPIOE_OTYPER  	*((volatile unsigned int *)(0x40021000+0X04))	//值转为地址，通过解引用访问地址空间的值
#define		GPIOE_OSPEEDR 	*((volatile unsigned int *)(0x40021000+0X08))	//值转为地址，通过解引用访问地址空间的值
#define		GPIOE_PUPDR   	*((volatile unsigned int *)(0x40021000+0X0C))	//值转为地址，通过解引用访问地址空间的值
#define		GPIOE_IDR     	*((volatile unsigned int *)(0x40021000+0X10))	//值转为地址，通过解引用访问地址空间的值
#define		GPIOE_ODR     	*((volatile unsigned int *)(0x40021000+0X14))	//值转为地址，通过解引用访问地址空间的值
